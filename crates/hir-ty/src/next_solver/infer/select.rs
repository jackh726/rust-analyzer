...
use crate::next_solver::{PolyTraitPredicate, SolverDefId};
...
pub enum SelectionCandidate<'db> {
    ...
    ParamCandidate(PolyTraitPredicate<'db>),
    ImplCandidate(SolverDefId),
    AutoImplCandidate,
...
impl EvaluationResult {
    ...
    pub fn must_apply_considering_regions(self) -> bool {
        self == EvaluationResult::EvaluatedToOk
    }

    /// Returns `true` if this evaluation result is known to apply, ignoring
    /// outlives constraints.
    pub fn must_apply_modulo_regions(self) -> bool {
        self <= EvaluationResult::EvaluatedToOkModuloRegions
    }
    ...
    pub fn may_apply(self) -> bool {
        match self {
            ...
            | EvaluationResult::EvaluatedToAmbigStackDependent => true,

            EvaluationResult::EvaluatedToErr => false,
        }
    }
